...
class PlancapacitacionRepository extends EntityRepository
{
  ...
  /**
   * Descripción: Función utilizada para comprobar si ya existe un plan registrado para el año seleccionado 
   * Retorno:     Cantidad de coincidencias con año enviado
   * Author:      Roquet  
   */
