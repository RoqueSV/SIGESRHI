 ...
 * @GRID\Source(columns="id,nombrecompleto,idplaza.nombreplaza,idexpediente.tipoexpediente,idexpediente.fechaexpediente",groups={"lista_expediente"})
  * @GRID\Source(columns="id,nombrecompleto,idplaza.nombreplaza,idexpediente.tipoexpediente,idexpediente.fechaexpediente",groups={"lista_expediente2"})
 */
...
class Solicitudempleo
{
     ...
     *
     * @GRID\Column(filterable=false, groups={"grupo_pruebapsicologica","grupo_pruebapsicologica_edit","grupo_pruebapsicologica_empleadoedit","solicitud_empleo","vista_basica_expediente","lista_expediente","lista_expediente2"}, visible=false)
     */
    private $id;
     ...
     * @GRID\Column(title="Nombre", filter="input", groups={"lista_expediente2","grupo_pruebapsicologica","grupo_pruebapsicologica_edit","grupo_pruebapsicologica_empleadoedit","solicitud_empleo","vista_basica_expediente"}, type="text", operators={"like"}, operatorsVisible=false, visible=false, filterable=false)
   ...
   public function getAceptar(){
     ...
     * })
     *
     * @GRID\Column(field="idplaza.nombreplaza", title="Puesto al que aplica", joinType="inner", filterable=false, groups={"grupo_pruebapsicologica","grupo_pruebapsicologica_edit","vista_basica_expediente", "solicitud_empleo"}, operators={"like"}, operatorsVisible=false, visible=false)
     * @GRID\Column(field="idplaza.nombreplaza", title="Puesto al que aplica", joinType="inner", filterable=false, groups={"lista_expediente","lista_expediente2"})
     */
    private $idplaza;
     ...
     * })
     *
     * @GRID\Column(primary=true, field="idexpediente.id", title="Idexpediente", joinType="inner",visible=false, filterable=false, groups={"grupo_pruebapsicologica","grupo_pruebapsicologica_edit","vista_basica_expediente","grupo_pruebapsicologica_empleadoedit"})
     * @GRID\Column(field="idexpediente.tipoexpediente", title="Estado", joinType="inner", filterable=false, groups={"grupo_pruebapsicologica","grupo_pruebapsicologica_edit","lista_expediente","lista_expediente2"})
     * @GRID\Column(field="idexpediente.tipoexpediente", title="Estado", joinType="inner", filterable=false, visible=false, groups={"vista_basica_expediente","grupo_pruebapsicologica_empleadoedit"})
     ...
     * @GRID\Column(field="idexpediente.fechaexpediente",type="date", joinType="inner", filterable=false, groups={"lista_expediente","lista_expediente2"}, visible=true, title="Fecha registro")
     * @GRID\Column(field="idexpediente.idpruebapsicologica.id", joinType="inner", filterable=false, groups={"grupo_pruebapsicologica_edit","grupo_pruebapsicologica_empleadoedit"}, visible=false)
     * @GRID\Column(field="idexpediente.idempleado.codigoempleado", joinType="inner", filterable=false, groups={"grupo_pruebapsicologica_empleadoedit"}, visible=false, operators={"like"})     
     */
