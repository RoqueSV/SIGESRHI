...
class Accionpersonal
{
     ...
     * @GRID\Column(filterable=true, groups={"grupo_consultar_acuerdo"}, visible=true, filter="input", type="date", inputType="datetime", format="d-m-Y", title="Fecha Registro", align="center", operators={"gte", "eq", "lte"}, defaultOperator="gte", operatorsVisible=true)
     */
