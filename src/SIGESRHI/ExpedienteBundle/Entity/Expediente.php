 ...
 * @GRID\Source(columns="id,tipoexpediente,idempleado.idcontratacion.puesto.idplaza.nombreplaza,idempleado.idcontratacion.id,idempleado.idcontratacion.fechafincontrato,idempleado.idcontratacion.fechafinnom,idempleado.idcontratacion.tipocontratacion", groups={"grupo_contratacion_consultar"})
...
class Expediente
{
     ...
     * @GRID\Column(field="idempleado.codigoempleado",groups={"grupo_empleado_inactivo","grupo_empleado","grupo_segurovida","grupo_contratacion_consultar","grupo_contratacion_empleado","grupo_solicitud_empleado", "grupo_acciones_empleado","grupo_empleado_activo"} ,title="Codigo", visible=false, joinType="inner", filterable=false)
     ...
     * @GRID\Column(field="idempleado.idrefrenda.idplaza.nombreplaza", groups={"grupo_segurovida","grupo_empleado","grupo_empleado_inactivo"},type="text", title="Plaza", filterable=false, joinType="inner")
     * @GRID\Column(field="idempleado.idrefrenda.idplaza.nombreplaza", groups={"grupo_contratacion_empleado","grupo_acciones_empleado"},type="text", title="Plaza", filterable=false)
     ...
     * @GRID\Column(field="idempleado.idcontratacion.fechafinnom", groups={"grupo_contratacion_consultar"},visible=false, filterable=false, joinType="inner")
     * @GRID\Column(field="idempleado.idcontratacion.fechafincontrato", groups={"grupo_contratacion_consultar"},visible=false, filterable=false, joinType="inner")
     * @GRID\Column(field="idempleado.idcontratacion.tipocontratacion", groups={"grupo_contratacion_consultar"},visible=false, filterable=false, joinType="inner")
