...
class Expediente
{
     ...
     * @GRID\Column(filterable=false, groups={"grupo_segurovida","grupo_contratacion","grupo_docdigital", "grupo_solicitud_empleado","grupo_empleado","grupo_empleado_inactivo", "grupo_acciones_empleado"}, visible=false)
     */
    private $id;
