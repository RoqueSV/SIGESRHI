...
class DatosempleoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('direccionempresa', 'textarea', array('label'=>'Dirección de la Empresa: ',  'attr' => array('class' => 'input-xmlarge')))
            ...
            ->add('sueldo', 'text',array('label'=>'Sueldo: ',  'attr' => array('class' => 'input-small dinero', 'data-bvalidator'=>'number,required')))
            ->add('motivoretiro','textarea', array('label'=>'Motivo del Retiro de la Empresa: ', 'attr' => array('class' => 'input-xmlarge')))
