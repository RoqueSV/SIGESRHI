...
class DatosempleoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('fechainiciolaboral',null, array('label'=>'Fecha de Inicio Laboral', 'widget' => 'single_text', 'format'=>'dd-MM-yyyy','attr' => array('class' => 'date')))
            ...
            ->add('motivoretiro','textarea', array('label'=>'Motivo del Retiro de la Empresa'))
