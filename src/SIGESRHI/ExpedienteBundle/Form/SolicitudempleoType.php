...
class SolicitudempleoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
             ->add('numsolicitud')
            ->add('apellidocasada', null, array('label'=>'Apellido de Casada: ', 'attr'=>array('class'=>'input-large')))
            ->add('primerapellido', null, array('label'=>'Primer Apellido: ', 'attr'=>array('class'=>'input-large')))
            ->add('segundoapellido', null, array('label'=>'Segundo Apellido: ', 'attr'=>array('class'=>'input-large')))
           ...
           // ->add('fecharegistro',null, array('widget' => 'single_text', 'format'=>'dd-MM-yyyy', 'attr' => array('class' => 'date input-small', 'readonly'=>true) ))
            ...
            ->add('parentescoparinst',null, array('label'=>'Parentesco: ', 'required'=>false ))
            ->add('dependenciaparinst', 'entity', array( 'label'=>'Dependencia donde labora: ','class'=>'AdminBundle:Unidadorganizativa', 'empty_value'=>'Seleccione una opción', 'mapped'=>false, 'required'=>false, 'attr' =>array('class'=> 'input-xlarge')))
            ->add('aceptar', 'checkbox', array ('label' => '','required' => true,))
            ;

            //agregamos un formulario de otra entidad (datos empleo)
            $builder->add('Dempleos', 'collection', array('label'=>' ', 'type' => new DatosempleoType(), 'allow_add' => true, 'allow_delete' => true, 'by_reference' => false));
