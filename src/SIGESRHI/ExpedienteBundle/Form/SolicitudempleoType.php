...
class SolicitudempleoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('telefonofijo', null, array('label'=>'Teléfono Fijo: ', 'max_length'=>'8', 'attr'=>array('class'=>'input-small telefono')))
            ->add('telefonomovil', null, array('label'=>'Teléfono Móvil: ', 'max_length'=>'8', 'attr'=>array('class'=>'input-small telefono')))
