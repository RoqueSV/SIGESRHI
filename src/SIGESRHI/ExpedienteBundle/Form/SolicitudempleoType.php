...
class SolicitudempleoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('fechanac', 'date', array('label'=>'Fecha de Nac. ', 'widget' => 'single_text', 'format'=>'dd-MM-yyyy', 'attr' => array('class' => 'date input-small'),) ) 
            ...
            ->add('fechadui', null, array('label'=>'Fecha se extendió el DUI: ', 'widget' => 'single_text', 'format'=>'dd-MM-yyyy','attr' => array('class' => 'date', 'readonly'=>true),))
            ...
            ->add('idplaza',null, array('required'=> true, 'label'=>'Plaza Solicitada: ', 'empty_value' => 'Seleccione una opción'))
            ->add('idexpediente')
            ->add('nombreparinst')
            ->add('parentescoparinst')
            ->add('dependenciaparinst')
            ;
