...
class SolicitudempleoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('nombres', null, array('label'=>'Nombres: ','attr'=>array('class'=>'input-large')))
            ->add('colonia', null, array('label'=>'Colonia: ', 'attr'=>array('class'=>'input-medium')))
            ->add('calle', null, array('label'=>'Numero/Calle/Avenida: ', 'attr'=>array('class'=>'input-large')))
            ...
            ->add('lugarnac', null, array('label'=>'Lugar de Nacimiento: ', 'attr'=>array('class'=>'input-xlarge')))
            ->add('fechanac', null, array('label'=>'Fecha de Nac.: ', 'widget' => 'single_text', 'format'=>'dd-MM-yyyy', 'attr' => array('class' => 'date input-small', 'data-bvalidator'=>'required', 'readonly'=>true),) ) 
            ...
            ->add('fechadui', null, array('label'=>'Fecha se extendió el DUI: ', 'widget' => 'single_text', 'format'=>'dd-MM-yyyy','attr' => array('class' => 'date input-small', 'data-bvalidator'=>'required', 'readonly'=>true),))
            ...
            ->add('sexo', 'choice', array('label'=>'Sexo: ', 'choices' => array('M' => 'Masculino ', 'F' => 'Femenino '),'required'  => true, 'expanded'=>false, 'empty_value'=>'Seleccione', 'attr'=>array('class'=>'input-medium')))
            ->add('fotografia', 'hidden', array('label'=>' Subir Fotografía: ',))
            ->add('file', 'file', array('label'=>' Subir Fotografía: ', 'required'=>true))
            //->add('fecharegistro','hidden', array('label'=>'Fecha de Registro: ', 'attr' => array('class' => 'input-small', 'readonly'=>true, 'required'=>false,)))
            //->add('fechamodificacion','hidden', array('label'=>'Fecha ultima de modificación: ', 'attr' => array('class' => 'input-small', 'readonly'=>true, 'required'=>false,)))
            ->add('idmunicipio', null,array('required' => true,'label'=>'Municipio: ', 'empty_value' => 'Seleccione', 'attr'=>array('class'=>'input-medium') ))
            ->add('departamentos', 'entity', array( 'label'=>'Departamento: ', 'class' => 'ExpedienteBundle:Departamento', 'empty_value' => 'Seleccione', 'mapped'=>false, 'attr'=>array('class'=>'input-medium')))
