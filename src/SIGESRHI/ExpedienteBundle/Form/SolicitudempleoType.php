...
class SolicitudempleoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('sexo', 'choice', array('label'=>'Sexo: ', 'choices' => array('M' => 'Masculino ', 'F' => 'Femenino '),'required'  => true, 'expanded'=>true))
           ...
           // ->add('fecharegistro',null, array('widget' => 'single_text', 'format'=>'dd-MM-yyyy', 'attr' => array('class' => 'date input-small', 'readonly'=>true) ))
            ...
            ->add('idmunicipio', null,array('required' => true,'label'=>'Municipio: ', 'empty_value' => 'Seleccione una opción', 'attr'=>array('class'=>'input-medium') ))
            ->add('departamentos', 'entity', array( 'label'=>'Departamento: ', 'class' => 'ExpedienteBundle:Departamento', 'empty_value' => 'Seleccione una opción', 'mapped'=>false, 'attr'=>array('class'=>'input-medium')))
