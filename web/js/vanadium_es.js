...
Vanadium.setupValidatorTypes = function() {
	...
	Vanadium
			.addValidatorTypes( [
					...
					[ "required", function(a) {
						return !Vanadium.validators_types.empty.test(a) && !/^\s+$/.test(a)
					...
					[
							...
							"Solo numeros en este campo." ],
                             /*By E.R*/           [
							"phone",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
										|| (!isNaN(a) && /([2|6|7]{1})+\d{7}/.test(a))
							},
							"Tel\xe9fono no v\xe1lido." ],        /*By E.R*/    
					[
							"float",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
							...
							"Por favor, introduzca un n\xFAmero valido en este campo." ],
					[
							"digits",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
							...
							"Por favor, use solo numeros en este campo. Por favor, evite espacios u otros caracteres, tales como puntos o comas." ],
					[
							"alpha",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
										|| /^[a-zA-Z\s\u00C0-\u00ff]+$/
												.test(a)
							}, "Solo letras en este campo." ],
                                        [
							"alphapoint", //Letras mas punto /*By E.R*/
							function(a) {
								return Vanadium.validators_types.empty.test(a)
										|| /^[a-zA-Z\s\.\u00C0-\u00ff]+$/
												.test(a)
					...
					[
							...
							"Solo letras ASCII (a-z) en este campo." ],
					[
							"alphanum",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
					...
					[
							...
							[
								...
								"La tarjeta de credito esta caducada." ],
					[
							"currency_dollar",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
							...
							"Por favor, introduzca un importe de $ valida. Por ejemplo, $ 100,00." ],
					[
							"selection",
							function(a, b) {
					...
					[
							...
							function(a, b) {
								return 'El valor debe ser como maximo <span class="'
										+ Vanadium.config.message_value_class
										+ '">'
										+ b
										+ "</span> caracteres de largo."
					...
					[
							...
							function(b, c) {
								var a = document.getElementById(c);
								if (a) {
									return 'El valor debe ser el mismo que Contrase\xF1a.'
